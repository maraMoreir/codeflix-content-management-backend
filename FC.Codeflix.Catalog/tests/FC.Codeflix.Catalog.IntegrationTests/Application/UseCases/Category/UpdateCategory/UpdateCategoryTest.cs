...
public class UpdateCategoryTest
{
    ...
    [Fact(DisplayName = nameof(UpdateThowsWhenFoundCategory))]
    [Trait("Integration/Application", "UpdateCategory - Use Cases")]
    public async Task UpdateThowsWhenFoundCategory()
    {
    ...
    [Theory(DisplayName = nameof(UpdateThrowsWhenCantInstatiateCategory))]
    [Trait("Integration/Application", "UpdateCategory - Use Cases")]
    [MemberData(
    ...
    public async Task UpdateThrowsWhenCantInstatiateCategory(
        UpdateCategoryInput input,
